CUTEP Electronic Structure Lab (2020)
C  Regularized SCAN 
C  The original code is from SCAN
C  This implementation is the same as JCP rSCAN [J. Chem. Phys. 150,
C  161101 (2019)] and may not work with PZSIC. For the SIC-rSCAN 
C  modification, see regscan.f
C  6/4/2019 YY
...
! YY. EXUNIF LDA Ex per particle and EXLDA is Ex
      ...
      TAU_UNIF=TAU_UNIF+1.0D-4
      ALPHA=(TAU_RHO-TAUW_RHO)/TAU_UNIF
      ALPHA=(ALPHA**3)/(ALPHA**2+1.0D-3)
